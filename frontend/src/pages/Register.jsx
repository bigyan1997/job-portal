  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F8F7F4", display: "flex" }}>
      ...
      >
        ...
        >
          Join thousands of job seekers and employers using AI to make better
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          {[
            ...
            { value: "50K+", label: "Registered professionals" },
      ...
      >
        <div style={{ width: "100%", maxWidth: "420px" }}>
          ...
          >
            {[
              { value: "jobseeker", label: "I'm a Job Seeker", icon: "👤" },
                ...
                style={{
                  ...
                  border:
                    formData.role === role.value
                      ? "2px solid #111827"
                      : "2px solid #E5E7EB",
                  background: formData.role === role.value ? "#111827" : "#fff",
                  color: formData.role === role.value ? "#fff" : "#6B7280",
                  fontSize: "13px",
                  fontWeight: 500,
