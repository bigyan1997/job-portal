...
from .views import JobListView, JobDetailView, ApplicationView, ApplicationDetailView, AnalyseResumeView, ATSAnalysisView, MyJobsView, SuggestResumeImprovementsView, BookmarkView
...
urlpatterns = [
    ...
    path('ats-analysis/', ATSAnalysisView.as_view()),
